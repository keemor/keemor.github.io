      ...
      <Card>
        ...
        <Card.Media>
          ...
          <ul>
            ...
            <li>
              <a href="https://github.com/babel/babel-preset-env">
                babel-preset-env
              </a>{" "}
              for ES6 & JSX support
            </li>
            <li>
              <a href="https://github.com/kentcdodds/webpack-config-utils">
                webpack-config-utils
              </a>{" "}
              in single <i>webpack.config.babel.js</i> for production and
              development
            </li>
            <li>
              <a href="https://github.com/NekR/offline-plugin">
                offline-plugin
              </a>{" "}
              for serving files when offline
            </li>
            <li>
              <a href="https://github.com/webpack/webpack-dev-server">
                webpack dev server
              </a>{" "}
